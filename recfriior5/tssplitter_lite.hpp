...
int split_select(splitter *sp, const uint8_t *data, int rlen);
void split_shutdown(splitter *sp);
int split_ts(splitter *splitter, const uint8_t *data, int rlen, splitbuf_t *dbuf);
